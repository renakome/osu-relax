...
namespace osu.Game.Rulesets.Osu.Mods
{
    ...
    {
        public override LocalisableString Description => @"Take it easy. Let the game handle the clicking for you while you focus on rhythm.";
        ...
        // Sem penalidade no score (igual ao osu!droid)
        public override double ScoreMultiplier => 1.0;

        // Alterado para permitir ranking como no osu!droid
